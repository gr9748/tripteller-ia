            ...
            <div className="flex flex-col items-center text-center space-y-4 mb-12">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                  Your personal travel assistant powered by Gemini AI. Get intelligent travel recommendations, itineraries, and insights.
                </p>
              </motion.div>
              ...
              >
                {!isAuthenticated ? (
                  ...
                  <p className="text-lg font-medium text-primary">
                    Welcome back! Start planning your next adventure below.
                  </p>
                )}
              </motion.div>
            </div>
